...
public class CuentaPremium extends Cuenta {
    public CuentaPremium(int numeroCuenta, BigDecimal saldoInicial) {
    ...
    public void depositar(BigDecimal monto, int tipoDeposito) {
        switch (tipoDeposito) {
            case 1:
                ...
                break;
            case 2:
                transacciones.agregarTransaccion(new Transacciones.Transaccion("Deposito", "cajero", monto, BigDecimal.ZERO));
                addSaldo(monto);
                break;
            case 3:
